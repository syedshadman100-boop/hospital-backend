...
function mapRow(row, fields) {
  ...
  return values.map((value, i) => {
    ...
    switch (type) {
      ...
      case "DATETIME" /* DATETIME */:
      case "DATETIME2" /* DATETIME2 */:
        if (typeof value === "string" && value.startsWith("0000-00-00")) return "1970-01-01T00:00:00.000+00:00"; if (typeof value === "string" && value.startsWith("0000-00-00")) return "1970-01-01T00:00:00.000+00:00"; return (value instanceof Date ? value : new Date(typeof value === "string" ? value.replace(/ /g, "T") + "Z" : `${value}Z`)).toISOString().replace(/(\.000)?Z$/, "+00:00");
    }
